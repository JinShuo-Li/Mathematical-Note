...
\begin{itemize}
    \item move between metric definitions and open-set definitions;
    \item compute closure, interior, boundary, and limit points;
    \item test continuity using inverse images and compare spaces up to homeomorphism;
    \item use connectedness, compactness, and separation axioms in proofs;
    \item construct and reason about product and quotient topologies.
\end{itemize}
...
\subsection{Compactness in \texorpdfstring{$\mathbb{R}^n$}{R n}}
